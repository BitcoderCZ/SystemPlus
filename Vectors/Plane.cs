...
namespace SystemPlus.Vectors
{
    public class Plane
    {
        ...
        public void FromPoints(Vector3 Point0, Vector3 Point1, Vector3 Point2)
        {
            ...
            Normal = Vector3.CrossProduct(edge1, edge2).Normalize();
            D = Vector3.DotProduct(-Normal, Point0);
        }
        ...
        public PlaneSide Intersects(AxisAlignedBoundingBox box)
        {
            ...
            float mdist = Math.Abs(Vector3.DotProduct(Normal, box.Size * 0.5f));
        ...
        {
            return Vector3.DotProduct(Normal, Point) + D;
        }
