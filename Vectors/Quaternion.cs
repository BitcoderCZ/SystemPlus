...
namespace SystemPlus.Vectors
{
    public class Quaternion
    {
        ...
        {   // From nVidia SDK
            ...
            t_uv = Vector3.CrossProduct(t_qvec, v);
            t_uuv = Vector3.CrossProduct(t_qvec, t_uv);
            t_uv *= 2.0f * q.w;
            t_uuv *= 2.0f;
            return v + t_uv + t_uuv;
        }
        ...
        {
            if ((float)Math.Sqrt(Axis.Length()) == 0.0f)
                return Identity;
        ...
        {
            System.Numerics.Quaternion q = System.Numerics.Quaternion.CreateFromYawPitchRoll(v3.y, v3.x, v3.z);
            return new Quaternion(q.X, q.Y, q.Z, q.W);
        }
